...
about = (Button) findViewById(R.id.about);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        void useWebAlert(){
            ...
            alertDialog.setTitle("IMPORTANT INFO");
            alertDialog.setMessage("Kindly Register,Add business and Activate business from our web platform.");

            alertDialog.setPositiveButton("Go", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog,int which) {
                    Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://metrokontact.com/index.php"));
                    startActivity(browserIntent);
                }
            });
