...
import com.greenmousetech.MetroKontact1.MainActivity;
import com.greenmousetech.MetroKontact1.MapActivity;
...
public class DashBoard extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Preferences = getSharedPreferences(LoginActivity.USERNAME, Context.MODE_PRIVATE);
        String fullname = Preferences.getString("PersonalName","");
    ...
    public void displayView(int viewId) {
        ...
        switch (viewId) {
            ...
            case R.id.edit_business:
                ...
                viewIsAtHome = false;
                break;
            case R.id.purchase_activation_code:
               fragment = new purchase_activationcode_fragment();
                viewIsAtHome = false;
                break;
        }
